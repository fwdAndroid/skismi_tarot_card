...
class WeeklyWebPage extends StatefulWidget {
  String url;
  String title;

  WeeklyWebPage({required this.title, required this.url});
  @override
  _WeeklyWebPageState createState() => new _WeeklyWebPageState();
}

class _WeeklyWebPageState extends State<WeeklyWebPage> {
